...
dados = [np.loadtxt('p3/projetil/projetil_a_%d.dat'%i).T \
...
plt.ylim(0,20000)
plt.xlim(0,53000)
plt.title('Trajetória do projétil (sem resistência do ar)')
plt.legend()
plt.savefig('p3/projetil/projetil_a_trajetorias.png',bbox_inches='tight')

# alcance em função do ângulo

alcance = np.loadtxt('p3/projetil/projetil_a_alcance.dat').T
...
plt.grid()
plt.ylim(min(alcance[1]),51000)
plt.xlim(30,60)
plt.xlabel('Ângulo (graus)')
plt.ylabel('Alcance (m)')
plt.title('Alcance do projétil (sem resistência do ar)')
plt.savefig('p3/projetil/projetil_a_alcance.png',bbox_inches='tight')
