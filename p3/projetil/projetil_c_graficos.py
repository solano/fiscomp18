...
dados = [np.loadtxt('p3/projetil/projetil_c_%d.dat'%i).T \
...
plt.ylim(0,12000)
plt.xlim(0,25000)
plt.title('Trajetória do projétil (densidade do ar variável)')
plt.legend()
plt.savefig('p3/projetil/projetil_c_trajetorias.png',bbox_inches='tight')

# alcance em função do ângulo

alcance = np.loadtxt('p3/projetil/projetil_c_alcance.dat').T
...
plt.grid()
plt.ylim(min(alcance[1]),25000)
plt.xlim(30,60)
plt.xlabel('Ângulo (graus)')
plt.ylabel('Alcance (m)')
plt.title('Alcance do projétil (densidade do ar variável)')
plt.savefig('p3/projetil/projetil_c_alcance.png',bbox_inches='tight')
